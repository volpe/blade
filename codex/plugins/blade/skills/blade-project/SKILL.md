---
name: blade-project
description: "Break an initiative into a Linear project with milestones and vertically sliced cards. Use for /blade-project or multi-feature scoping — not for a single ticket."
---
