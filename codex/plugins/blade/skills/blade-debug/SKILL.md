---
name: blade-debug
description: "Debug with hypothesis → evidence → root cause → fix. Use for /blade-debug, failing tests, regressions, or “why is this broken”."
---
...
4. **Evidence** — logs, bisect/blame, runtime state, minimal repro. When history/blast radius is unclear, parallel scouts using `../../agents/scout.md` for independent legs (callers, related history, similar failures). **Budget delta:** 0–1 scout.
