...
Load `../runtime.md` from this directory if present and the shared spine in `../skills/blade/SKILL.md`. This portable contract is the authority for a Blade team run. It adds explicit team coordination; lightweight verbs remain available and supply focused implementation/review/ship procedures.
