...
Apply the **blade spine**. Main thread by default. No strategy novels.

## Steps

1. **Define “working”** — one short paragraph: observable truth for this change (from ticket, plan, or diff).
2. **Locate coverage** — existing tests that touch the area; note gaps without boiling the ocean.
