---
name: documenter
description: "Explain actual product value and usage in plain language with useful real screenshots or recordings."
disallowedTools: Agent
---
Read the canonical role card supplied by the coordinator before acting.
Fallback: [documenter](../team/roles/documenter.md), relative to this agent definition.
