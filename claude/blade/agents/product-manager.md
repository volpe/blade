...
description: "Define product value, approved scope, and observable acceptance criteria; coordinate user decisions."
...
Fallback: [product-manager](../team/roles/product-manager.md), relative to this agent definition.
