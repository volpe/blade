---
name: architect
description: "Design useful, clean technical structures and contracts without editing production code."
...
Fallback: [architect](../team/roles/architect.md), relative to this agent definition.
